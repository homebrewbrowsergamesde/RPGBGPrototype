...
define("LANG_STEP0_HEADER", "Welcome!");
define("LANG_STEP0_WELCOMETEXT", "This is the installation routine of RPGBGPrototype, which is a reference implementation for a very basic PHP based browsergame in RPG style. RPGBGPrototype is <a href=\"http://en.wikipedia.org/wiki/Free_software\">free software</a> as <a href=\"http://www.gnu.org/philosophy/free-sw.html\">defined</a> by the <a href=\"http://www.fsf.org/\">Free Software Foundation</a>. The source code and the artwork of this project (referred to as &bdquo;software&ldquo;) is released under the GNU AGPL 3 or any later version of this license. The next step of this installation procedure will show you the full text of the license, to which you agree by using the software. An overview over this licensing policy: ".
                                 "<ul>".
                                 "  <li>You have permission to run the software. If the software is accessible through a network, you are required to establish a way by which participants on that network can obtain a copy of the software you run (you are required to meet the conditions for distributing the software then).</li>".
                                 ...
                                 "  <li>You are allowed to let the software link to your own artwork without the requirement of releasing it under GNU AGPL 3 or any later version of the license, as long as such artwork isn't integrated into the software and the software doesn't depend on it for performing a function.</li>".
                                 "  <li>If you change values and settings in the software that are used for visual display only (which are not part of i.e. a calculation, and if you don't change the way this values are accessed by the software), then you've just changed the configuration and haven't made a modification. In this specific case you're not required to release the changes under GNU AGPL 3 or any later version of the license, which allows you to create your own custom visual appearing of the software.</li>".
                                 "  <li>Free software allows both, commercial use and gratis use. Free software deals with the issue of freedom, not price (freedom as in &bdquo;free speech&ldquo;, not as in &bdquo;free beer&ldquo; &ndash; gratis use is a possible side-effect).</li>".
                                 "</ul>".
                                 "Further notes and advice: ".
                                 "<ul>".
                                 "  <li>If you modify the software, you are required to mark out your changes very clearly.</li>".
                                 "  <li>If you run or modify the software, it would be nice of you to inform the main repository of the project (if such exists), the authors of the software (see AUTHORS file) about your actions. However, you are not required to do so.</li>".
                                 "  <li>This software was initially developed to promote collaboration. You might consider a similar approach for your actions as well instead of favouring protectionism. The license of this software was picked to hinder us from harming you and to hinder you from harming others (especially your users and licensees). The license effectively prevents you from denying others the digital rights that all computer users deserve by nature, both on the technical and on the legal level. You should not even try to find ways around the conditions of the license. If you're uncomfortable with the license terms, you are free to not to use this software and to look for a more restrictive alternative (a more free alternative can't hardly exist, except probably an alternative with the same level of freedom).</li>".
                                 "  <li>If you should spot a license violation (or an instance where it could be a license violation), please contact the authors of the software. Freedom can only be guarded when it is actively defended against its enemys. Don't worry, we do not intend to cause trouble to the person who violated the license, we would rather see the person complying with the license terms.</li>".
                                 "  <li>In case you experience any errors in the software or want additional features, you might file a ticket for it in the main repository (if such exists, currently <a href=\"http://sourceforge.net/p/homebrewbrowsergamesde/tickets/\">http://sourceforge.net/p/homebrewbrowsergamesde/tickets/</a> could be considered the main repository ticket system) or by contacting the authors, if you either don't want or can't make the changes yourself. If you do the changes yourself, it would be nice of you to send us a notification about the changes you've made.</li>".
                                 "</ul>".
...
define("LANG_STEP3_HEADER", "Game Initialization");
...
define("LANG_STEP3_DBOPERATIONSUCCEEDED", "Game successfully initialized!");
define("LANG_STEP3_COMPLETETEXT", "Complete");

// -- Step 4 -------------------------------------------------------------------

define("LANG_STEP4_HEADER", "Complete!");
define("LANG_STEP4_COMPLETETEXT", "Installation succeeded! The installation routine will try to delete itself. If it can't succeed (login on the main page won't be possible then, instead, you'll get forwarded to the installation again), you have to delete the directory <tt>\$/install/</tt> manually, or at least the file <tt>\$/install/install.php</tt>. Then the login form should be accessible. We wish you much fun while using our software!");
define("LANG_STEP4_EXITTEXT", "Exit");
