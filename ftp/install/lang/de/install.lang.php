...
define("LANG_STEP0_HEADER", "Herzlich willkommen!");
define("LANG_STEP0_WELCOMETEXT", "Dies ist der Installationsvorgang von RPGBGPrototype, einer Referenz-Implementierung für ein einfaches auf PHP basierendes Browsergame im RPG-Stil. RPGBGPrototype ist <a href=\"http://de.wikipedia.org/wiki/Freie_Software\">freie Software</a> gemäß der <a href=\"http://www.gnu.org/philosophy/free-sw.de.html\">Definition</a> der US-amerikanischen <a href=\"http://www.fsf.org/\">Free Software Foundation</a> (Freie-Software-Stiftung, siehe auch die europäische <a href=\"http://www.fsfe.org\">Free Software Foundation Europe</a>). Der Quellcode und die Grafiken dieses Projekts (&bdquo;Software&ldquo; genannt) sind unter der GNU AGPL 3 oder jeder späteren Version dieser Lizenz veröffentlicht worden. Im nächsten Schritt des Installationsvorgangs wird der vollständige Lizenztext angezeigt, welchem Sie zustimmen, indem Sie die Software verwenden. Ein Überblick der Konsequenzen unserer Lizenzpolitik: ".
                                 "<ul>".
                                 "  <li>Es ist Ihnen gestattet, die Software auszuführen. Wenn die Software über ein Netzwerk zugänglich ist, sind Sie verpflichtet, einen Weg einzurichten, über welchen Teilnehmer dieses Netzwerkes die Software, welche Sie ausführen, erhalten können (Sie müssen dabei die Bedingungen für die Weitergabe erfüllen).</li>".
                                 ...
                                 "Jedoch: ".
                                 "<ul>".
                                 "  <li>Werte in der Datenbank müssen nicht mit dem Quellcode veröffentlicht werde, solange sie durch Benutzer-Interaktion generiert wurden und nicht für die interne Funktionsweise der Software verantwortlich sind.</li>".
                                 "  <li>Es dürfen eigene Grafiken von der Software verlinken lassen, ohne die Grafiken unter GNU AGPL 3 oder einer späteren Version dieser Lizenz veröffentlichen zu müssen, solange die Grafiken nicht in die Software integriert sind und die Software nicht zur Ausführung einer Funktion davon abhängt.</li>".
                                 "  <li>Wenn Sie Werte und Einstellungen in der Software ändern, die ausschließlich für die visuelle Darstellung verwendet werden (die nicht Teil sind einer Berechnung beispielsweise, und wenn Sie die Art und Weise, wie die Software auf diese Werte zugreift, nicht verändern), dann haben Sie lediglich die Konfiguration angepasst und keine eigentliche Veränderung vorgenommen. In diesem speziellen Fall sind Sie nicht dazu verpflichtet, die Anpassungen unter der GNU AGPL 3 oder einer späteren Version der Lizenz zu veröffentlichen, was es Ihnen gestattet, eigene individuelle Erscheinungsformen der Software zu gestalten.</li>".
                                 "  <li>Freie Software erlaubt beides, kommerzielle Nutzung und kostenfreie Nutzung. Bei freier Software geht es in erster Linie um Freiheit, nicht um den Preis (Freiheit im Sinne von &bdquo;Redefreiheit&ldquo; und nicht im Sinne von &bdquo;Freibier&ldquo; &ndash; kostenfreie Nutzung ist ein möglicher Seiteneffekt).</li>".
                                 "</ul>".
                                 ...
                                 "  <li>Wenn Sie die Software ausführen oder verändern, wäre es nett von Ihnen, das primäre Repository des Projekts (sofern vorhanden), die Autoren der Software (siehe AUTHORS-Datei) über Ihre Aktivitäten zu informieren. Sie sind allerdings nicht dazu verpflichtet.</li>".
                                 "  <li>Diese Software wurde initial entwickelt, um Zusammenarbeit zu fördern. Sie sollten ebenfalls über einen ähnlichen Ansatz für Ihre Aktivitäten nachdenken, anstatt Protektionismus zu befürworten. Die Lizenz für diese Software wurde gewählt, um uns daran zu hindern, Ihnen Schaden zuzufügen, und um Sie daran zu hindern, Anderen Schaden zuzufügen (insbesondere ihren Benutzern und Lizenznehmern). Die Lizenz verhindert effektiv, dass Sie Anderen die digitalen Rechte vorenthalten, welche allen Computer-Benutzern naturgemäß zustehen, sowohl auf der technischen als auch auf der rechtlichen Ebene. Sie sollten nicht einmal versuchen, die Lizenzbestimmungen umgehen zu wollen. Wenn Ihnen die Lizenzbestimmungen nicht zusagen, können Sie sich auch frei dafür entscheiden, die Software nicht zu benutzen und eine restriktivere Alternative suchen (eine freiere Alternative kann wohl schwerlich existieren, außer vielleicht eine Alternative mit demselben Freiheitsgrad).</li>".
                                 ...
                                 "  <li>Falls Sie auf einen Fehler in der Software stoßen oder zusätzliche Features haben möchten, können Sie ein Ticket dafür im primären Repository (sofern vorhanden, momentan kann <a href=\"http://sourceforge.net/p/homebrewbrowsergamesde/tickets/\">http://sourceforge.net/p/homebrewbrowsergamesde/tickets/</a> als das Ticket-System des primären Repositorys betrachtet werden) anlegen oder die Autoren kontaktieren, wenn Sie die Änderungen selbst entweder nicht durchführen wollen oder können. Wenn Sie die Änderungen selbst vornehmen, wäre es nett von Ihnen, uns eine Benachrichtigung über die vorgenommenen Änderungen zukommen zu lassen.</li>".
                                 "</ul>".
...
define("LANG_STEP3_HEADER", "Spiel einrichten");
...
define("LANG_STEP3_DBOPERATIONSUCCEEDED", "Spiel erfolgreich eingerichtet!");
define("LANG_STEP3_COMPLETETEXT", "Einrichtung abschließen");

// -- Step 4 -------------------------------------------------------------------

define("LANG_STEP4_HEADER", "Fertig!");
define("LANG_STEP4_COMPLETETEXT", "Installation erfolgreich abgeschlossen! Die Installationsroutine wird nun versuchen, sich selbst zu löschen. Wenn dies nicht gelingen sollte (Sie sich also nicht auf der Hauptseite am Spiel anmelden können und wieder zur Installation umgeleitet werden), müssen Sie das Verzeichnis <tt>\$/install/</tt> manuell löschen, mindestens jedoch die Datei <tt>\$/install/install.php</tt>. Anschließend sollte das Anmeldeformular zugänglich sein. Wir wünschen Ihnen viel Spaß bei der Benutzung unserer Software!");
define("LANG_STEP4_EXITTEXT", "Beenden");
